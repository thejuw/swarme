      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p>
              By accessing or using the Edge-Swarm platform ("Service"), you agree to be bound by
          ...
          <section>
            ...
            <p>
              The Edge-Swarm platform utilizes artificial intelligence to suggest and execute changes
            ...
            <p className="mt-3">
              ...
              approval of published content remains your responsibility. Edge-Swarm shall not be held
          ...
          <section>
            ...
            <p>
              ...
              platforms), you grant Edge-Swarm limited, scoped API access to read and modify content
          ...
          <section>
            ...
            <p>
              ...
              any unauthorized use. Edge-Swarm reserves the right to suspend or terminate accounts
          ...
          <section>
            ...
            <p>
              ...
              to your store. The Edge-Swarm platform, its underlying technology, algorithms, and
              proprietary methods remain the exclusive property of Edge-Swarm and its licensors.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <span className="text-foreground font-medium">legal@edge-swarm.com</span>.
            </p>
          </section>
        </div>
      </main>
